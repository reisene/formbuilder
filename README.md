...
| ------------------------------ | ------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Framework                      | [Next.js 16](https://nextjs.org) (App Router)                                                                                  | ![GitHub package.json prod dependency version](https://img.shields.io/github/package-json/dependency-version/reisene/formbuilder/next)                                                                                                                                                                                                                                                                                                                               |
| UI                             | [React 19](https://react.dev), [React Bootstrap 2](https://react-bootstrap.github.io), [Bootstrap 5](https://getbootstrap.com) | ![GitHub package.json prod dependency version](https://img.shields.io/github/package-json/dependency-version/reisene/formbuilder/react) ![GitHub package.json prod dependency version](https://img.shields.io/github/package-json/dependency-version/reisene/formbuilder/react-bootstrap) ![GitHub package.json prod dependency version](https://img.shields.io/github/package-json/dependency-version/reisene/formbuilder/bootstrap)                                |
| Language                       | [TypeScript](https://www.typescriptlang.org) (`strict` mode)                                                                   | ![GitHub package.json dev/peer/optional dependency version](https://img.shields.io/github/package-json/dependency-version/reisene/formbuilder/dev/typescript)                                                                                                                                                                                                                                                                                                        |
| Styling                        | SCSS (Sass) with CSS custom properties                                                                                         | ![GitHub package.json prod dependency version](https://img.shields.io/github/package-json/dependency-version/reisene/formbuilder/sass)                                                                                                                                                                                                                                                                                                                               |
| Icons                          | [react-icons](https://react-icons.github.io/react-icons)                                                                       | ![GitHub package.json prod dependency version](https://img.shields.io/github/package-json/dependency-version/reisene/formbuilder/react-icons)                                                                                                                                                                                                                                                                                                                        |
| Forms & validation _(planned)_ | React Hook Form, Zod                                                                                                           | ![GitHub package.json prod dependency version](https://img.shields.io/github/package-json/dependency-version/reisene/formbuilder/react-hook-form) ![GitHub package.json prod dependency version](https://img.shields.io/github/package-json/dependency-version/reisene/formbuilder/zod)                                                                                                                                                                              |
| Drag & drop _(planned)_        | dnd-kit                                                                                                                        | ![GitHub package.json prod dependency version](https://img.shields.io/github/package-json/dependency-version/reisene/formbuilder/%40dnd-kit%2Fcore) ![GitHub package.json prod dependency version](https://img.shields.io/github/package-json/dependency-version/reisene/formbuilder/%40dnd-kit%2Fsortable) ![GitHub package.json prod dependency version](https://img.shields.io/github/package-json/dependency-version/reisene/formbuilder/%40dnd-kit%2Futilities) |
| State management _(planned)_   | Zustand                                                                                                                        | ![GitHub package.json prod dependency version](https://img.shields.io/github/package-json/dependency-version/reisene/formbuilder/zustand)                                                                                                                                                                                                                                                                                                                            |
